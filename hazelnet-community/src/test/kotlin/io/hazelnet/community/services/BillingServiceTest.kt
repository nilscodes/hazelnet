...
internal class BillingServiceTest {
    ...
    fun calculateMonthlyActualCostInLovelace() {
        ...
        assertEquals(25000000, getCost(billingService, 50, 0))
        assertEquals(15000000, getCost(billingService, 50, 200))
        assertEquals(0, getCost(billingService, 50, 600))
        assertEquals(25000000, getCost(billingService, 100, 0))
        assertEquals(20000000, getCost(billingService, 100, 200))
        assertEquals(0, getCost(billingService, 100, 1000))
        assertEquals(25000000, getCost(billingService, 250, 0))
        assertEquals(15000000, getCost(billingService, 250, 1000))
        assertEquals(0, getCost(billingService, 250, 4000))
        assertEquals(25000000, getCost(billingService, 500, 0))
        assertEquals(20000000, getCost(billingService, 500, 1000))
        assertEquals(0, getCost(billingService, 500, 8000))
        assertEquals(50000000, getCost(billingService, 1000, 0))
        assertEquals(40000000, getCost(billingService, 1000, 2000))
        assertEquals(0, getCost(billingService, 1000, 12000))
        assertEquals(50000000, getCost(billingService, 2000, 0))
        assertEquals(40000000, getCost(billingService, 2000, 4000))
        assertEquals(0, getCost(billingService, 2000, 24000))
        assertEquals(75000000, getCost(billingService, 5000, 0))
        assertEquals(45000000, getCost(billingService, 5000, 20000))
        assertEquals(0, getCost(billingService, 5000, 60000))
        assertEquals(100000000, getCost(billingService, 10000, 0))
        assertEquals(90000000, getCost(billingService, 10000, 10000))
        assertEquals(40000000, getCost(billingService, 10000, 60000))
        assertEquals(100000000, getCost(billingService, 20000, 0))
        assertEquals(90000000, getCost(billingService, 20000, 20000))
        assertEquals(70000000, getCost(billingService, 20000, 60000))
        assertEquals(120000000, getCost(billingService, 25000, 10000))
        assertEquals(100000000, getCost(billingService, 25000, 50000))
        assertEquals(75000000, getCost(billingService, 25000, 100000))
        assertEquals(147000000, getCost(billingService, 50000, 10000))
        assertEquals(120000000, getCost(billingService, 50000, 100000))
        assertEquals(90000000, getCost(billingService, 50000, 200000))
        assertEquals(171500000, getCost(billingService, 100000, 20000))
        assertEquals(157500000, getCost(billingService, 100000, 100000))
        assertEquals(105000000, getCost(billingService, 100000, 400000))
    }
    ...
    fun calculateMaximumDelegationDiscountAmountInLovelace() {
        ...
        assertEquals(2500000000000, billingService.calculateMaximumDelegationDiscountAmountInLovelace(250000))
    }

    @Test
    fun calculateMonthlyTotalCostInLovelace() {
        val billingService = BillingService(mockk(), mockk(), mockk(), mockk(), mockk(), mockk(), mockk())
        assertEquals(25000000, billingService.calculateMonthlyTotalCostInLovelace(50))
        assertEquals(25000000, billingService.calculateMonthlyTotalCostInLovelace(999))
        assertEquals(50000000, billingService.calculateMonthlyTotalCostInLovelace(1000))
        assertEquals(50000000, billingService.calculateMonthlyTotalCostInLovelace(4999))
        assertEquals(75000000, billingService.calculateMonthlyTotalCostInLovelace(5000))
        assertEquals(75000000, billingService.calculateMonthlyTotalCostInLovelace(9999))
        assertEquals(100000000, billingService.calculateMonthlyTotalCostInLovelace(10000))
        assertEquals(100000000, billingService.calculateMonthlyTotalCostInLovelace(24999))
        assertEquals(125000000, billingService.calculateMonthlyTotalCostInLovelace(25000))
        assertEquals(125000000, billingService.calculateMonthlyTotalCostInLovelace(49999))
        assertEquals(150000000, billingService.calculateMonthlyTotalCostInLovelace(50000))
        assertEquals(150000000, billingService.calculateMonthlyTotalCostInLovelace(99999))
        assertEquals(175000000, billingService.calculateMonthlyTotalCostInLovelace(100000))
        assertEquals(175000000, billingService.calculateMonthlyTotalCostInLovelace(249999))
        assertEquals(200000000, billingService.calculateMonthlyTotalCostInLovelace(500000))
