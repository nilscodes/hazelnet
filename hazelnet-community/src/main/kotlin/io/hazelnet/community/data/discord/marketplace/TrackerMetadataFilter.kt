...
@Entity
@Table(name = "discord_marketplace_filters")
class TrackerMetadataFilter @JsonCreator constructor(
    @Id
    ...
    override fun toString(): String {
        return "TrackerMetadataFilter(id=$id, attributeName='$attributeName', operator=$operator, attributeValue='$attributeValue')"
    }
}