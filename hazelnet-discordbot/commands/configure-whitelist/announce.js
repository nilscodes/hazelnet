    ...
    if (interaction.customId === 'configure-whitelist/announce/publish') {
      ...
      if (whitelistToAnnounce) {
        ...
        try {
          ...
          const embedPublic = embedBuilder.buildForUser(discordServer, i18n.__({ phrase: 'configure.whitelist.announce.publicSuccessTitle', locale }), i18n.__({ phrase: 'configure.whitelist.announce.publicSuccess', locale }), 'whitelist-register', detailFields);
