...
module.exports = {
  async execute(interaction) {
    try {
      ...
      const marketplaceChannelFields = marketplaceChannels.map((marketplaceChannel) => marketplaceUtil.getMarketplaceChannelDetailsField(discordServer, marketplaceChannel, 'list.entry', 'add'));
