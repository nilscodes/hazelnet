  ...
  async execute(interaction) {
    try {
      ...
      if (!currentMemberData) {
        ...
        const embed = embedBuilder.buildForUser(discordServer, i18n.__({ phrase: 'verify.link.messageTitle', locale: useLocale }), i18n.__({ phrase: 'verify.link.success', locale: useLocale }), 'verify-link');
