...
module.exports = {
  async execute(interaction) {
    try {
      ...
      const embed = embedBuilder.buildForUserWithAd(discordServer, i18n.__({ phrase: 'verify.remove.messageTitle', locale: useLocale }), i18n.__({ phrase: 'verify.remove.success', locale: useLocale }, { address: addressToRemove }), 'verify-remove');
