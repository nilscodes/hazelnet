  ...
  async execute(interaction) {
    try {
      ...
      if (mainAccount.settings?.BLACKLISTED !== 'true') {
        ...
        const embed = embedBuilder.buildForUserWithAd(externalAccount, discordServer, i18n.__({ phrase: 'verify.remove.messageTitle', locale }), i18n.__({ phrase: 'verify.remove.success', locale }, { address: addressToRemove }), 'verify-remove');
