  ...
  async execute(interaction) {
    try {
      ...
      if (currentMemberData) {
        ...
        const embed = embedBuilder.buildForUserWithAd(externalAccount, discordServer, i18n.__({ phrase: 'verify.unlink.messageTitle', locale: useLocale }), i18n.__({ phrase: 'verify.unlink.success', locale: useLocale }), 'verify-unlink');
