...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      const embed = embedBuilder.buildForUser(discordServer, i18n.__({ phrase: 'policyid.messageTitle', locale: useLocale }), i18n.__({ phrase: 'policyid.purpose', locale: useLocale }), tokenPolicies);
