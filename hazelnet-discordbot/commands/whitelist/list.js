...
module.exports = {
  async execute(interaction) {
    ...
    try {
      ...
      const embed = embedBuilder.buildForUser(discordServer, i18n.__({ phrase: 'whitelist.list.messageTitle', locale: useLocale }), i18n.__({ phrase: 'whitelist.list.purpose', locale: useLocale }), whitelistFields);
