...
module.exports = {
  async execute(interaction) {
    ...
    let customizationValue = interaction.options.getString('customization-value');
    try {
      ...
      await interaction.editReply({ guildId: interaction.guild.id, content: 'Error while customizing bot. Please contact your bot admin via https://www.hazelnet.io.', ephemeral: true });
    }
  },
  isValidUrl(url) {
