...
import { DiscordMarketplaceChannelType, DiscordServer, ExternalAccount, Marketplace, MarketplaceChannel, MarketplaceChannelPartial, TokenPolicy } from '@vibrantnet/core';
...
export default <ConfigureMarketplaceMintAddCommand> {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ content: 'Error while getting mint channel list to announce. Please contact your bot admin via https://www.vibrantnet.io.' });
    }
  },
