...
export default <BotSubcommand> {
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ content: `Error while adding metadata filter to tracker with ID ${trackerId} on your server. Please contact your bot admin via https://www.hazelnet.io.` });
    }
  },
};
