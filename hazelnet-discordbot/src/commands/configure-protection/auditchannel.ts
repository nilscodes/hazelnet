...
export default <BotSubcommand> {
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ content: 'Error while adjusting audit info channel setting for your server. Please contact your bot admin via https://www.vibrantnet.io.' });
    }
  },
};
