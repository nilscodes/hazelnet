...
export default <BotSubcommand> {
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ content: `Error while adding policy to auto-role assignment for role with ID ${tokenRoleId} on your server. Please contact your bot admin via https://www.hazelnet.io.` });
    }
  },
};
