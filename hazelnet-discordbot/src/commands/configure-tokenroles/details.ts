...
export default <BotSubcommand> {
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ content: `Error while showing details of auto-role assignment for role with ID ${tokenRoleId} from your server. Please contact your bot admin via https://www.vibrantnet.io.` });
    }
  },
};
