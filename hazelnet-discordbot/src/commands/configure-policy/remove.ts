...
export default <BotSubcommand> {
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ content: 'Error while removing official token policy from your server. Please contact your bot admin via https://www.vibrantnet.io.' });
    }
  },
};
