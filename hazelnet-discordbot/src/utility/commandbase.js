...
module.exports = {
  typescriptCommands: ['whois', 'profile', 'premium', 'somersault', 'configure-api', 'configure-info', 'configure-social', 'configure-policy', 'configure-giveaway', 'configure-poll', 'join'],
